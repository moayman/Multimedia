...
int FFMPEGNative :: open_input_file(const char * filename, AVFormatContext ** input_format_context, AVCodecContext ** input_codec_context)
{
    AVCodec *input_codec;
    int error;
...
int FFMPEGNative ::  open_output_file(const char *filename, AVCodecContext *input_codec_context, AVFormatContext **output_format_context,
                     AVCodecContext **output_codec_context)
{
    ...
    {
        fprintf(stderr, "Could not find an MP2 encoder.\n");
        goto cleanup;
    }
...
int FFMPEGNative ::  init_resampler(AVCodecContext *input_codec_context, AVCodecContext *output_codec_context, SwrContext **resample_context)
{
    int error;
    /**
...
int FFMPEGNative ::  init_fifo(AVAudioFifo **fifo, AVCodecContext *output_codec_context)
{
...
int FFMPEGNative ::  write_output_file_header(AVFormatContext *output_format_context)
{
    int error;
...
int FFMPEGNative ::  decode_audio_frame(AVFrame *frame, AVFormatContext *input_format_context, AVCodecContext *input_codec_context,
...
int FFMPEGNative ::  init_converted_samples(uint8_t ***converted_input_samples, AVCodecContext *output_codec_context, int frame_size)
{
    int error;
    //uint8_t * temp;
    /**
...
// by frame_size.
int FFMPEGNative ::  convert_samples(const uint8_t **input_data, uint8_t **converted_data, const int frame_size, SwrContext *resample_context)
{
    int error;
...
int FFMPEGNative ::  add_samples_to_fifo(AVAudioFifo *fifo, uint8_t **converted_input_samples, const int frame_size)
{
    int error;
...
int FFMPEGNative ::  read_decode_convert_and_store(AVAudioFifo *fifo, AVFormatContext *input_format_context, AVCodecContext *input_codec_context,
...
int FFMPEGNative ::  init_output_frame(AVFrame **frame, AVCodecContext *output_codec_context, int frame_size)
{
    int error;
...
int FFMPEGNative ::  encode_audio_frame(AVFrame *frame, AVFormatContext *output_format_context, AVCodecContext *output_codec_context, int *data_present)
{
    // Packet used for temporary storage.
...
// output file.
int FFMPEGNative ::  load_encode_and_write(AVAudioFifo *fifo, AVFormatContext *output_format_context, AVCodecContext *output_codec_context)
{
...
int FFMPEGNative ::  write_output_file_trailer(AVFormatContext *output_format_context)
{
    int error;
...
void FFMPEGNative ::  init_packet(AVPacket *packet)
{
...
int FFMPEGNative ::  init_input_frame(AVFrame **frame)
{
    if (!(*frame = av_frame_alloc()))
    {
...
int FFMPEGNative ::   convert_wav_to_mp3(char* input_file, char* output_file)
{
	...
	if (open_output_file(output_file, input_codec_context, &output_format_context, &output_codec_context))
        goto cleanup;
