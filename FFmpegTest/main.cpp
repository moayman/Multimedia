...
static int open_output_file(const char *filename, AVCodecContext *input_codec_context, AVFormatContext **output_format_context,
...
static int decode_audio_frame(AVFrame *frame, AVFormatContext *input_format_context, AVCodecContext *input_codec_context,
...
static int read_decode_convert_and_store(AVAudioFifo *fifo, AVFormatContext *input_format_context, AVCodecContext *input_codec_context,
...
int main()
{
    ...
    if (open_input_file("bullet.wav", &input_format_context, &input_codec_context))
        goto cleanup;

    // Open the output file for writing.
    if (open_output_file("bullet.mp2", input_codec_context, &output_format_context, &output_codec_context))
        goto cleanup;
...
// Open the input file and get the required information
static int open_input_file(const char * filename, AVFormatContext ** input_format_context, AVCodecContext ** input_codec_context)
{
    AVCodec *input_codec;
    int error;
                     ...
                     AVCodecContext **output_codec_context)
{
    ...
    if (!(output_codec = avcodec_find_encoder(AV_CODEC_ID_MP2)))
    {
